/*
Q. Design a payment system like amazon have when we click on pay it give option to select payment method and direct us to 3rd party system. Design database and table schema for it and also design api endpoints we will be needing. Implement above feature using interfaces,services and dependency injection ?
*/
